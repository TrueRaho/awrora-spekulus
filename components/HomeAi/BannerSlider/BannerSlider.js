                    ...
                    <Box px={{ sm: 3 }}>
                      <div className={classes.text}>
                        ...
                        <div className={classes.btnArea}>
                          <Button component={LocaleLink} size="large" color="primary" variant="contained" to={link.contact} className={classes.button}>
                            {t('btn_get')}
                          </Button>
                    ...
                    <div className={cx(classes.text, align.textCenter)}>
                      ...
                      <div className={classes.btnArea}>
                        <Box justifyContent="center">
                          <Button component={LocaleLink} size="large" color="primary" variant="contained" href="https://antot-12.github.io/Spekulus-Presentation/" className={classes.button}>
                            {t('btn_get')}
                          </Button>
                          <Button size="large" color="black" variant="contained" href="https://antot-12.github.io/Spekulus-Presentation/" className={classes.button}>
                            {t('btn_detail')}
                          </Button>
                        </Box>
                      </div>
